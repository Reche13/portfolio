...
export const Hero = () => {
  return (
    <Container className="w-full px-4 md:px-10 pb-8 pt-24 bg-zinc-50 dark:bg-zinc-900 shadow-reche">
      ...
      <Link
        href="/resume.pdf"
        className="w-fit mt-6 border-[2px] cursor-pointer border-zinc-300 dark:border-zinc-600 hover:border-orange-600 hover:bg-orange-500/5 text-zinc-500 dark:text-zinc-400 hover:text-orange-600 transition duration-300 text-xs font-medium flex items-center gap-1 py-1.5 px-2 rounded-xl"
      >
